            ...
            if (TalkingNpc == Abominationn)
            {
                switch (npcPhrase)
                {
                    case "Where'd I get my scythe from? Ask me later.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.1");
                        break;
                    case "Where'd I get my scythe from? You'll figure it out.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.2");
                        break;
                    case "I have defeated everything in this land... nothing can beat me.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.3");
                        break;
                    case "Have you ever had a weapon stuck to your hand? It's not very handy.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.4");
                        break;
                    case "What happened to Yoramur? No idea who you're talking about.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.5");
                        break;
                    case "You wish you could dress like me? Ha! Maybe in 2020.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.6");
                        break;
                    case "You ever read the ancient classics, I love all the fighting in them.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.7");
                        break;
                    case "I'm a world class poet, ever read my piece about impending doom?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.8");
                        break;
                    case "You want swarm summons? Maybe next year.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.9");
                        break;
                    case "Like my wings? Thanks, the thing I got them from didn't like it much.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.10");
                        break;
                    case "Heroism has no place in this world, instead let's just play ping pong.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.11");
                        break;
                    case "Why are you looking at me like that? Your fashion sense isn't going to be winning you any awards either.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.12");
                        break;
                    case "No, you can't have my hat.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.13");
                        break;
                    case "Embrace suffering... Wait what do you mean that's already taken?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.14");
                        break;
                    case "Your attempt to exploit my anger is admirable, but I cannot be angered.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.15");
                        break;
                    case "Is it really a crime if everyone else does it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.16");
                        break;
                    case "Inflicting suffering upon others is the most amusing thing there is.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.17");
                        break;
                    case "Irony is the best kind of humor, isn't that ironic?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.18");
                        break;
                    case "I like Cat... What do you mean who's Cat?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.19");
                        break;
                    case "Check the wiki if you need anything, the kirb is slowly getting it up to par.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.20");
                        break;
                    case "I've heard tales of a legendary Diver... Anyway what was that about a giant jellyfish?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.21");
                        break;
                    case "Overloaded events...? Yeah, they're pretty cool.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.22");
                        break;
                    case "It's not like I don't enjoy your company, but can you buy something?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.23");
                        break;
                    case "I have slain one thousand humans! Huh? You're a human? There's so much blood on your hands..":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.24");
                        break;
                    case "I don't think there's an event right now.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.28");
                        break;
                    case "You really defeated me... not bad. Now do it again without getting hit. Oh, and Copper Shortsword only.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Abominationn.29");
                        break;
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Abominationn.25"), Main.npc[Mutant].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Abominationn.26"), Main.npc[Deviantt].GivenName);
                }

                if (Mechanic.IsExistingNPC() && npcPhrase == $"Can you please ask {Main.npc[Mechanic].GivenName} to stop touching my laser arm please.")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Abominationn.27"), Main.npc[Mechanic].GivenName);
                }
            ...
            else if (TalkingNpc == Deviantt)
            {
                switch (npcPhrase)
                {
                    ...
                    case "Who do you think we are? We're parts of you, a few hundred million years from now after you shed the need for a physical body.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.20");
                        break;
                    case "Mutant is inhabiting the physical shell of your future self, but we're all manifestations of your power and experience.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.21");
                        break;
                    case "In our first past, it took you eons to amass power. Since we happened to come back, we decided to help speed it up a little!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.22");
                        break;
                    case "Even if the three of us joined forces again, we still wouldn't regain the full power of our original self. You could probably still beat us!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.23");
                        break;
                    case "To accelerate your growth, Mutant released his powers to the rest of the world. Good work gathering it all back for yourself!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.24");
                        break;
                    case "Don't worry about our true names. We don't actually have any!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.25");
                        break;
                    ...
                    case "I once heard Mutant mention a once cat-like being so far beyond us that its existence transcends cause and effect. It's more like a law of reality.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.33");
                        break;
                    case "What's that? You want to fight me for real? ...nah, I can't put up a good fight on my own.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.41");
                        break;
                    case "Hey, you've almost made it to the end! Got all your Soul accessories ready? What's that? You want to fight my big brother? ...maybe if he had a reason to.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.42");
                        break;
                    case "Ready to fight my big brother? Remember how you've learned to learn. Stay focused, look for patterns, and don't panic. Good luck!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.43");
                        break;
                    case "Only a specific type of weapon will work against each specific pillar. As for that moon guy, his weakness will keep changing.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.44");
                        break;
                    case "Some powerful enemies like that dungeon guy can create their own arenas. You won't be able to escape, so make full use of the room you do have.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.45");
                        break;
                    case "Did you beat that fish pig dragon yet? He reduces your maximum life a little on every hit. He's also strong enough to break defenses in one hit. Too bad you don't have any reinforced plating to prevent that, right?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.46");
                        break;
                    case "That temple? Reach the altar to regain wire control! The golem gets upset when you leave, so fighting in there is best. Platforms won't work, but a Lihzahrd Instactuation Bomb can help clear space!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.47");
                        break;
                    case "That overgrown plant inflicts a special venom that works her into an enraged frenzy if she stacks enough hits on you. She also has a ring of crystal leaves, but minions go through it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.48");
                        break;
                    case "Good work getting one over on me! Hope I didn't make you sweat too much. Keep at the grind - I wanna see how far you can go!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.49");
                        break;
                    case "That metal worm has a few upgrades, but its probes were downgraded to compensate. It'll start shooting homing dark stars and flying. When it coils around you, don't try to escape!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.50");
                        break;
                    case "I saw that metal eye spinning while firing a huge laser the other day. Also, even if you kill them, they won't die until they're both killed!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.51");
                        break;
                    case "Focus on taking down that metal skull, not its limbs. Don't try to outrun its spinning limbs! Keep your eyes open and learn to recognize what's doing what.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.52");
                        break;
                    case "That thing's mouth is as good as immune to damage, so you'll have to aim for the eye. Only one of them is vulnerable at a time, though. What thing? You know, that thing!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.53");
                        break;
                    case "Next up is me! Make sure you can recognize whatever attack I'll throw at you. Blocks and turning away can nullify petrification!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.54");
                        break;
                    case "The master of the dungeon can use its babies to attack! Which attack it uses depends on whether or not it's spinning. It'll also take a last stand, so be ready to run when you make the kill!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.55");
                        break;
                    case "The queen bee will summon her progeny for backup. She's harder to hurt while they're there, so take them out first. Oh, and her swarm can't hit right above or below her!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.56");
                        break;
                    case "Focus on how the ichor moves and don't get overwhelmed! When the brain gets mad, it'll confuse you every few seconds. Four rings to confuse you, one ring when it wears off!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.57");
                        break;
                    ...
                    case "That big eyeball has the power of the moon, but it's too flashy for its own good! Learn to notice and focus only on the bits that threaten to hurt you.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.61");
                        break;
                    case "Gonna fight that slime king soon? Crafting a Mini Instabridge or two might help, and mind the spike rain. Don't stay up and out of his range or he'll get mad, though!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.62");
                        break;
                    case "Seems like everyone's learning to project auras these days. If you look at the particles, you can see whether it'll affect you at close range or a distance!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.63");
                        break;
                    case "There's probably a thousand items to protect against all these debuffs. It's a shame you don't have a thousand hands to carry them all at once!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.64");
                        break;
                    ...
                    case "I don't have any more Life Crystals for you, but I think my big brother left some in the fat slime king. Maybe he'll share if you beat it up!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.68");
                        break;
                    case "I've always wondered why those other monsters never bothered to carry any healing potions. Well, you probably shouldn't wait and see if they actually do.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.69");
                        break;
                    ...
                    case "The underworld has gotten a lot hotter since the last time I visited. I hear an obsidian skull is a good luck charm against burning alive, though!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.72");
                        break;
                    case "Want to have a breath-holding contest? The empty vacuum of space would be perfect. No, I won't cheat by breathing water instead of air!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.73");
                        break;
                    ...
                    //     npcPhrase = LangUtils.GetText("Fargo.NpcChatText.Deviantt.74");
                    //     break;
                    // case "Why not go hunting for some rare monsters every once in a while? Plenty of treasure to be looted and all that.":
                    //     npcPhrase = LangUtils.GetText("Fargo.NpcChatText.Deviantt.75");
                    //     break;
                    ...
                    //     npcPhrase = LangUtils.GetText("Fargo.NpcChatText.Deviantt.76");
                    //     break;
                    case "If you ask me, Plantera is really letting herself go. A diet of Chlorophyte Ore and Life Fruit isn't THAT healthy! Why don't you help her slim down?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.77");
                        break;
                    case "Trick or treat? Merry Christmas? I don't have anything for you, but go ask Pumpking or Ice Queen!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.78");
                        break;
                    case "Wanna craft Forces, but missing Enchantments? Craft the Sigil of Champions and they'll give you what you want, so long as you earn it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.79");
                        break;
                    case "Now's a good time to go for Betsy! Don't worry. If you reach the last wave and lose, you won't have to retry the event for more attempts at her. Careful not to slip up before then, and mind her debuffs!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.80");
                        break;
                    case "That's a funny face you're making... Is the underground Hallow too disorienting? Try controlling gravity on your own and maybe it can't flip you by force!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Deviantt.81");
                        break;
                }

                if (npcPhrase == $"{Main.LocalPlayer.name}! I saw something rodent-y just now! You don't have a hamster infestation, right? Right!?")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.34"), Main.LocalPlayer.name);
                }
                ...
                if (Mutant.IsExistingNPC())
                {
                    ...
                    {
                        npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.35"), Main.npc[Mutant].GivenName);
                    }
                    else if (npcPhrase == $"One day, I'll sell a summon for myself! ...Just kidding. That's {Main.npc[Mutant].GivenName}'s job.")
                    {
                        npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.36"), Main.npc[Mutant].GivenName);
                    }
                    else if (npcPhrase == $"{Main.npc[Mutant].GivenName} is here! That's my big brother!")
                    {
                        npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.37"), Main.npc[Mutant].GivenName);
                    }
                }

                if (Abominationn.IsExistingNPC() && npcPhrase == $"{Main.npc[Abominationn].GivenName} is here! That's my big-but-not-biggest brother!")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.38"), Main.npc[Abominationn].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.39"), Main.npc[LumberJack].GivenName);
                }

                if (Angler.IsExistingNPC() && npcPhrase == $"Have you ever considered throwing {Main.npc[Angler].GivenName} back where you found him?")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Deviantt.40"), Main.npc[Angler].GivenName);
                }
            }
            else if (TalkingNpc == LumberJack)
            {
                switch (npcPhrase)
                {
                    case "Dynasty wood? Between you and me, that stuff ain't real wood!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.1");
                        break;
                    case "Sure cactus isn't wood, but I can still chop it with me trusty axe.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.2");
                        break;
                    case "You wouldn't by chance have any fantasies about me... right?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.3");
                        break;
                    case "I eat a bowl of woodchips for breakfast... without any milk.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.4");
                        break;
                    case "TIIIIIIIIIMMMBEEEEEEEERRR!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.5");
                        break;
                    case "I'm a lumberjack and I'm okay, I sleep all night and I work all day!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.6");
                        break;
                    case "You won't ever need an axe again with me around.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.7");
                        break;
                    case "I have heard of people cutting trees with fish, who does that?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.8");
                        break;
                    case "You wanna see me work without my shirt on? Maybe in 2030.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.9");
                        break;
                    case "You ever seen the world tree?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.10");
                        break;
                    case "You want what? ...Sorry that's not the kind of wood I'm selling.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.11");
                        break;
                    case "Why don't I sell acorns? ...I replant all the trees I chop, don't you?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.12");
                        break;
                    case "What's the best kind of tree? ... Any if I can chop it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.13");
                        break;
                    case "Can I axe you a question?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.14");
                        break;
                    case "Might take a nap under a tree later, care to join me?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.15");
                        break;
                    case "I'm an expert in all wood types.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.16");
                        break;
                    case "I wonder if there'll be more trees to chop in 1.4.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.17");
                        break;
                    case "Red is one of my favourite colors, right after wood.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.18");
                        break;
                    case "It's always flannel season.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.19");
                        break;
                    case "I'm glad my wood put such a big smile on your face.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.20");
                        break;
                    case "Astroturf? Sorry I only grow trees on real grass.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.21");
                        break;
                    case "Yew tree? Sakura tree? Nope, haven't found any.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.22");
                        break;
                    case "While I was chopping down a cactus these things leaped at me, why don't you take care of them?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.23");
                        break;
                    case "These mahogany trees are full of life, but a tree only has one purpose: to be chopped. Oh yea this fell out of the last one.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.24");
                        break;
                    case "This place is a bit fanciful for my tastes, but the wood's as choppable as any. Nighttime has these cool bugs though, take a few.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.25");
                        break;
                    case "Whatever causes these to glow is beyond me, you're probably gonna eat them anyway so have this while you're at it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.LumberJack.26");
                        break;
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.LumberJack.34"), Main.npc[Nurse].GivenName);
                }
            }
            else if (TalkingNpc == Mutant)
            {
                switch (npcPhrase)
                {
                    case "Savagery, barbarism, bloodthirst, that's what I like seeing in people.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.1");
                        break;
                    case "The stronger you get, the more stuff I sell. Makes sense, right?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.2");
                        break;
                    case "There's something all of you have that I don't... Death perception, I think it's called?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.3");
                        break;
                    case "It would be pretty cool if I sold a summon for myself...":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.4");
                        break;
                    case "The only way to get stronger is to keep buying from me and in bulk too!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.5");
                        break;
                    case "Why are you looking at me like that, all I did was eat an apple.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.6");
                        break;
                    case "Don't bother with anyone else, all you'll ever need is right here.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.7");
                        break;
                    case "You're lucky I'm on your side.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.8");
                        break;
                    case "Thanks for the house, I guess.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.9");
                        break;
                    case "Why yes I would love a ham and swiss sandwich.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.10");
                        break;
                    case "Should I start wearing clothes? ...Nah.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.11");
                        break;
                    case "It's not like I can actually use all the gold you're spending.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.12");
                        break;
                    case "Violence for violence is the law of the beast.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.13");
                        break;
                    case "Those guys really need to get more creative. All of their first bosses are desert themed!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.14");
                        break;
                    case "You say you want to know how a Mutant and Abominationn are brothers? You're better off not knowing.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.15");
                        break;
                    case "I'm all you need for a calamity.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.16");
                        break;
                    case "Everything shall bow before me! ...after you make this purchase.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.17");
                        break;
                    case "It's clear that I'm helping you out, but uh.. what's in this for me? A house you say? I eat zombies for breakfast.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.18");
                        break;
                    case "Can I jump? No, I don't have something called a 'spacebar'.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.19");
                        break;
                    case "Got your nose, I needed one to replace mine.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.20");
                        break;
                    case "What's a Terry?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.21");
                        break;
                    case "Why do so many creatures carry around a weird looking blue doll? The world may never know.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.22");
                        break;
                    case "Impending doom approaches. ...If you don't buy anything of course.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.23");
                        break;
                    case "I've heard of a '3rd dimension', I wonder what that looks like.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.24");
                        break;
                    case "Boy don't I look fabulous today.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.25");
                        break;
                    case "You have fewer friends than I do eyes.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.26");
                        break;
                    case "The ocean is a dangerous place, I wonder where Diver is?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.27");
                        break;
                    case "Do you know what an Ee-arth is?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.28");
                        break;
                    case "I can't even spell 'apotheosis', do you expect me to know what it is?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.29");
                        break;
                    case "Where do monsters get their gold from? ...I don't have pockets you know.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.30");
                        break;
                    case "Dogs are cool and all, but cats don't try to bite my brain.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.31");
                        break;
                    case "Beware the green dragon... What's that face mean?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.32");
                        break;
                    case "Where is this O-hi-o I keep hearing about.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.33");
                        break;
                    case "I've told you 56 times already, I'm busy... Oh wait you want to buy something, I suppose I have time.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.34");
                        break;
                    case "I've heard of a 'Soul of Souls' that only exists in 2015.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.35");
                        break;
                    case "Adding EX after everything makes it way more difficult.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.36");
                        break;
                    case "I think that all modern art looks great, especially the bloody stuff.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.37");
                        break;
                    case "How many guides does it take to change a lightbulb? ... I don't know, how about you ask him.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.38");
                        break;
                    case "Good thing I don't have a bed, I'd probably never leave it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.39");
                        break;
                    case "What's this about an update? Sounds rare.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.40");
                        break;
                    case "If you need me I'll be slacking off somewhere.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.41");
                        break;
                    case "What do you mean who is Fargo!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.42");
                        break;
                    case "Have you seen the ech cat?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.43");
                        break;
                    case "I don't understand music nowadays, I prefer some smooth jazz... or the dying screams of monsters.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.44");
                        break;
                    case "Cthulhu's got nothing on me!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.45");
                        break;
                    case "Now that you've defeated the big guy, I'd say it's time to start collecting those materials!":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.46");
                        break;
                    case "What's that? You want to fight me? ...sure, I guess.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.47");
                        break;
                    case "What's that? You want to fight me? ...maybe if I had a reason.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.48");
                        break;
                    case "What's that? You want to fight me? ...you're not worthy you rat.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.49");
                        break;
                    case "Why would you do this.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.50");
                        break;
                    case "I feel a great imbalance in this world.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.51");
                        break;
                    case "A great choice, shame about that first desert boss thing though.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.52");
                        break;
                    case "A bit spooky tonight, isn't it.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.53");
                        break;
                    case "I'd ask for a coat, but I don't think you have any my size.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.54");
                        break;
                    case "Weather seems odd today, wouldn't you agree?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.55");
                        break;
                    case "Lovely night, isn't it?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.56");
                        break;
                    case "I hope the constant arguing I'm hearing isn't my fault.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.57");
                        break;
                    case "I'd follow and help, but I'd much rather sit around right now.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.58");
                        break;
                    case "I don't know what everyone's so happy about, but as long as nobody mistakes me for a Pigronata, I'm happy too.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.59");
                        break;
                    case "Congratulations. You truly embraced eternity... at least, I think you did? So what happens next? Ascend from this plane of existence? Fight a transcendant cat-like entity? Destroy the world? All the power's in your hands now.":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.74");
                        break;
                    case "Good work beating me, I guess. I still feel like stretching my wings... Why don't we go at it for real next time?":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.75");
                        break;
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.60"), Main.npc[PartyGirl].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.61"), Main.npc[Mutant].GivenName, Main.npc[LumberJack].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.62"), Main.npc[Nurse].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.63"), Main.npc[WitchDoctor].GivenName);
                }

                if (Dryad.IsExistingNPC() && npcPhrase == $"Why does {Main.npc[Dryad].GivenName}'s outfit make my wings flutter?")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.64"), Main.npc[Dryad].GivenName);
                }

                if (Stylist.IsExistingNPC() && npcPhrase == $"{Main.npc[Stylist].GivenName} once gave me a wig... I look hideous with long hair.")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.65"), Main.npc[Stylist].GivenName);
                }

                if (Truffle.IsExistingNPC() && npcPhrase == "That mutated mushroom seems like my type of fella.")
                {
                    npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Mutant.66");
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.67"), Main.npc[TaxCollector].GivenName);
                }

                if (Guide.IsExistingNPC() && npcPhrase == $"Any idea why {Main.npc[Guide].GivenName} is always cowering in fear when I get near him?")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.68"), Main.npc[Guide].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.69"), Main.npc[WitchDoctor].GivenName, Main.npc[Truffle].GivenName, Main.npc[Cyborg].GivenName);
                }

                if (PartyGirl.IsExistingNPC() && npcPhrase == $"Man, {Main.npc[PartyGirl].GivenName}'s confetti keeps getting stuck to my wings")
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.70"), Main.npc[PartyGirl].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.71"), Main.npc[Demolitionist].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.72"), Main.npc[DD2Bartender].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangHelper.GetText("Fargo.NpcChatText.Mutant.73"), Main.npc[DyeTrader].GivenName);
                }
            }
            else if (TalkingNpc == Squirrel)
            {
                switch (npcPhrase)
                {
                    case "[c/ff0000:You will suffer.]":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Squirrel.1");
                        break;
                    case "*squeak*":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Squirrel.2");
                        break;
                    case "*chitter*":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Squirrel.3");
                        break;
                    case "*crunch crunch*":
                        npcPhrase = LangHelper.GetText("Fargo.NpcChatText.Squirrel.4");
                        break;
                }
            }
