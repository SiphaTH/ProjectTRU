...
public class UIBestiaryPatch : ContentTranslation, ILoadableContent
{
    ...
    private void UIBestiaryNPCEntryPortraitOnctor(On.Terraria.GameContent.UI.Elements.UIBestiaryNPCEntryPortrait.orig_ctor orig, UIBestiaryNPCEntryPortrait self, BestiaryEntry entry, Asset<Texture2D> portraitbackgroundasset, Color portraitcolor, List<IBestiaryBackgroundOverlayAndColorProvider> overlays)
    {
        ...
        self.Append(new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Portrait_Front", AssetRequestMode.ImmediateLoad).Value)
        {
            VAlign = 0.5f,
            HAlign = 0.5f,
    ...
    private UIElement NPCStatsReportInfoElementOnProvideUIElement(On.Terraria.GameContent.Bestiary.NPCStatsReportInfoElement.orig_ProvideUIElement orig, NPCStatsReportInfoElement self, BestiaryUICollectionInfo info)
    {
        ...
        UIImage uIImage = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_HP", AssetRequestMode.ImmediateLoad).Value) {
            Top = new StyleDimension(num4, 0f),
            Left = new StyleDimension(num3, 0f)
        };

        UIImage uIImage2 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Attack", AssetRequestMode.ImmediateLoad).Value) {
            Top = new StyleDimension(num4 + num2, 0f),
            Left = new StyleDimension(num3, 0f)
        };

        UIImage uIImage3 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Defense", AssetRequestMode.ImmediateLoad).Value) {
            Top = new StyleDimension(num4 + num2, 0f),
            Left = new StyleDimension(num3 + num, 0f)
        };
  
        UIImage uIImage4 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Knockback", AssetRequestMode.ImmediateLoad).Value) {
            Top = new StyleDimension(num4, 0f),
            Left = new StyleDimension(num3 + num, 0f)
        };
        ...
        if (num7 > 0)
        {
            ...
            UIImage uIImage5 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Platinum", AssetRequestMode.ImmediateLoad).Value) {
                Top = new StyleDimension(num9, 0f),
                Left = new StyleDimension(num8, 0f)
            };

            UIImage uIImage6 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Gold", AssetRequestMode.ImmediateLoad).Value) {
                Top = new StyleDimension(num9, 0f),
                Left = new StyleDimension(num8 + num10, 0f)
            };

            UIImage uIImage7 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Silver", AssetRequestMode.ImmediateLoad).Value) {
                Top = new StyleDimension(num9, 0f),
                Left = new StyleDimension(num8 + num10 * 2 + 1, 0f)
            };

            UIImage uIImage8 = new UIImage(ModContent.Request<Texture2D>("CalamityRuTranslate/Vanilla/UI/Stat_Copper", AssetRequestMode.ImmediateLoad).Value) {
                Top = new StyleDimension(num9, 0f),
