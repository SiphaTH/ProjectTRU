...
public class DrawDraedonSelectionUIWithAthenaHandleInteractionWithButton : ILPatcher
{
    ...
    public override ILContext.Manipulator PatchMethod { get; } = il =>
    {
        ...
        TranslationHelper.ModifyIL(il, "Artemis and Apollo, a pair of extremely agile destroyers with unstable energy reserves.", "Артемида и Аполлон - тандем чрезвычайно маневренных уничтожителей, обладающих нестабильным энергетическим запасом.");
    };
}