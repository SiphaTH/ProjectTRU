...
namespace CalamityRuTranslate.ThoriumMod.Tiles
{
	internal class ThoriumTiles
	{
		...
		private static void Tiles()
		{
			...
			ModTile tile123 = TileLoader.GetTile(thorium.TileType("CursedBlock"));
			...
			ModTile tile124 = TileLoader.GetTile(thorium.TileType("CursedChest"));
			...
			ModTile tile125 = TileLoader.GetTile(thorium.TileType("FurnitureCup"));
			...
			ModTile tile126 = TileLoader.GetTile(thorium.TileType("FurnitureDresser"));
			...
			ModTile tile127 = TileLoader.GetTile(thorium.TileType("FurnitureDresser"));
			...
			ModTile tile128 = TileLoader.GetTile(thorium.TileType("FurnitureDresser"));
			...
			ModTile tile130 = TileLoader.GetTile(thorium.TileType("FurnitureToilet"));
			...
			ModTile tile132 = TileLoader.GetTile(thorium.TileType("ShadyChest"));
			...
			ModTile tile133 = TileLoader.GetTile(thorium.TileType("TrappedChests"));
			...
			ModTile tile136 = TileLoader.GetTile(thorium.TileType("TrappedChests"));
