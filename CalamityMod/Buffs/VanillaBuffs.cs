            ...
            if (calamity != null && LanguageManager.Instance.ActiveCulture == GameCulture.Russian)
            {
	            if (CalamityRuTranslate.TRuConfig.CalamityTranslation)
	            {
		            switch (type)
		            {
			            ...
			            case 10:
				            tip =
					            "Даёт невидимость. Дарует разбойные бонусы, держа в руках определённое разбойное оружие";
				            break;
			            case 1:
			            ...
			            case 87:
				            ...
				            {
					            tip =
						            "Восстановление жизни немного ускорено. Обеспечивает защитой от холода в режиме Смерти";
				            }
