...
namespace CalamityRuTranslate.Vanilla
{
    public class RussianPrefixOverhaul
    {
        ...
        public static string[][] Prefixes = {
			...
			new [] {"Злосчастный", "Злосчастная", "Злосчастное", "Злосчастные"},
			...
			new [] {"Поддельный", "Поддельная", "Поддельное", "Поддельные"},
			...
			new [] {"Счастливый", "Счастливая", "Счастливое", "Счастливые"},
			...
			new [] {"Раздражающий", "Раздражающая", "Раздражающее", "Раздражающие"},
