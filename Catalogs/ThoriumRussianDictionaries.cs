    ...
    public static class ThoriumRussianDictionaries
    {
        ...
        public static void LoadDictionaries()
        {
            ThoriumBuffs = new Dictionary<string, (string, string)>
            {
                ...
                {"Corrosion", ("Коррозия", "Получение на 5% больше урона от всех источников и урона с течением времени")},
                ...
                {"LichActive", ("Восстановление лича", "Получение смертельного урона воскресит вас с 25% здоровья")},
                {"LichNotActive", ("Отступление лича", "Получение смертельного урона убьёт вас...")},
                ...
                {"Cured", ("Исцелённый", "Дарует невосприимчивость к дебаффам, наносящим урон и дарует регенерацию здоровья")},
                ...
                {"DreamBuff", ("Сновидец", "Невосприимчив к большинству повреждений и дебаффов")},
                ...
                {"Savior", ("Освобождённый", "Невосприимчив к большинству повреждений и дебаффов")},
                {"SerpentsBubble", ("Змеиный пузырь", "Регенерация здоровья увеличивена и сопротивление урону увеличено на 10%")},
