            ...
            else if (TalkingNpc == DrunkPrincess)
            {
                switch (npcPhrase)
                {
                    ...
                    case "You lost or something? I don't mind company, but I'd rather be left alone at night.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.19");
                        break;
                    ...
                    case "I'm melting! Put a stop to this inclement weather this instant before it ruins my hair!":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.31");
                        break;
                    case "I saw a ghost down by the old train tracks back at my homeland once, flailing wildly at the lily pads... frightening times those were.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.32");
                        break;
                    case "I hear it's amazing when the famous Devourer of Gods out in flap-jaw space, with the tuning fork, does a raw blink on Hara-kiri rock. I need scissors! 61!":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.33");
                        break;
                    ...
                    case "I'm gonna make some Bloody Marys to relax, celery included. Want one?":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.45");
                        break;
                    case "If you're too lazy to craft potions normally, try Blood Orbs. Blood is fuel, dumbass.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.46");
                        break;
                    case "I'm trying to not be bitchy tonight, but it's hard when everyone else won't shut up.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.47");
                        break;
                    case "Sorry, I have no moral compass at the moment.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.48");
                        break;
                }
                if (npcPhrase == $"You have failed {Main.player[Main.myPlayer].Calamity().deathCount} time.")
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.49"), npcPhrase.Split(' ')[3]);
                }
                else if (npcPhrase == $"You have failed {Main.player[Main.myPlayer].Calamity().deathCount} times.")
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.50"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.51"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.52"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.53"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.54"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.55"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.56"), npcPhrase.Split(' ')[3]);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.57"), npcPhrase.Split(' ')[3]);
                }
                if (Bartender.IsExistingNPC())
                {
                    if (npcPhrase == "I've had to tell baldie where my eyes are so many times that I've lost count.")
                    {
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.FAP.34");
                    }
                    if (npcPhrase == $"Tell {Main.npc[Bartender].GivenName} to stop calling me. He's not wanted.")
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.35"), Main.npc[Bartender].GivenName);
                    }
                    ...
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.36"), Main.npc[Bartender].GivenName);
                    }
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.37"), Main.npc[Archmage].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.38"), Main.npc[Witch].GivenName);
                }
                if (Stylist.IsExistingNPC())
                {
                    if (npcPhrase == $"You can't stop me from trying to move in with {Main.npc[Stylist].GivenName}.")
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.4"), Main.npc[Stylist].GivenName);
                    }
                    else if (npcPhrase == $"I love it when {Main.npc[Stylist].GivenName}'s hands get sticky from all that... wax.")
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.5"), Main.npc[Stylist].GivenName);
                    }
                    else if (npcPhrase == $"{Main.npc[Stylist].GivenName} works wonders for my hair... among other things.")
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.6"), Main.npc[Stylist].GivenName);
                    }
                    ...
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.7"), Main.npc[Stylist].GivenName);
                    }
                    ...
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.8"), Main.npc[Stylist].GivenName);
                    }
                    else if (npcPhrase == $"Might go out for a jog later with {Main.npc[Stylist].GivenName}. Nice day for it.")
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.14"), Main.npc[Stylist].GivenName);
                    }
                    ...
                    {
                        npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.FAP.21"), Main.npc[Stylist].GivenName);
                    }
                }
            ...
            else if (TalkingNpc == Bandit)
            {
                switch (npcPhrase)
                {
                    ...
                    case "Hey, if government officials can get tax, why can't I? The heck do you mean that these two things are nothing alike?":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.33");
                        break;
                    case "Sorry, I got nothing. Perhaps you could reforge something and come back later...":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.34");
                        break;
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.28"), Main.npc[Merchant].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.30"), Main.npc[DrunkPrincess].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.31"), Main.npc[Nurse].GivenName, Main.npc[ArmsDealer].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtils.TranslationKey("Calamity.NpcChatText.THIEF.32"), Main.npc[GoblinTinkerer].GivenName);
                }
            }
            else if (TalkingNpc == Witch)
            {
                switch (npcPhrase)
                {
                    ...
                    case "One of these days, I was thinking of starting a garden with the flowers from the old capitol of hell. I love the smell of brimstone in the morning.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Witch.4");
                        break;
                    case "I think I've settled comfortably, thank you very much.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Witch.5");
                        break;
                    case "Many seasons have gone by since I first met with the Tyrant, and only now did I break free. I wish I'd been stronger...":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Witch.6");
                        break;
                ...
                {
                    npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Witch.12");
                }
                ...
                {
                    npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Witch.13");
                }
                ...
                {
                    npcPhrase = String.Format(LangUtils.TranslationKey("Calamity.NpcChatText.Witch.14"), Main.npc[DrunkPrincess].GivenName);
                }
            }
            ...
            else if (TalkingNpc == Wizard)
            {
                switch (npcPhrase)
                {
                    case "Space just got way too close for comfort.":
                        npcPhrase = LangUtils.TranslationKey("Calamity.NpcChatText.Wizard.1");
                        break;
                }
            }
