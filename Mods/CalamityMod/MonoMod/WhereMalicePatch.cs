...
public class WhereMalicePatch : ILPatcher
{
    ...
    public override ILContext.Manipulator PatchMethod { get; } = il =>
    {
        ...
        TranslationHelper.ModifyIL(il, ":If you want more difficulty, try the Infernum Addon, Master Mode, higher Boss HP Config, or for amusement, For The Worthy]", ":Если хотите сложности, попробуйте мод Infernum, режим Мастера, увеличить здоровье боссов в настройках или для веселья генерацию мира For The Worthy]");
    };
}