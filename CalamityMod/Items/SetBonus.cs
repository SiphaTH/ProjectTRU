        ...
        public override string IsArmorSet(Item head, Item body, Item legs)
        {
            if (ModCompatibility.CalamityMod != null && LanguageManager.Instance.ActiveCulture == GameCulture.Russian)
            {
                if (CalamityRuTranslate.TRuConfig.CalamityTranslation)
                {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("ForbiddenCirclet") &&
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("ShroomiteVisage") &&
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AerospecHat") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AerospecBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AerospecLeggings"))
                    {
                        return "AerospecMagic";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("AerospecHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AerospecBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AerospecLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AerospecHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AerospecBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AerospecLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AerospecHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AerospecBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AerospecLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AerospecHood") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AerospecBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AerospecLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AstralHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AstralBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AstralLeggings"))
                    {
                        return "Astral";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("AtaxiaHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AtaxiaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AtaxiaSubligar"))
                    {
                        return "AtaxiaRanged";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("AtaxiaHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AtaxiaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AtaxiaSubligar"))
                    {
                        return "AtaxiaMelee";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AtaxiaHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AtaxiaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AtaxiaSubligar"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AtaxiaHood") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AtaxiaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AtaxiaSubligar"))
                    {
                        return "AtaxiaRogue";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AtaxiaMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AtaxiaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AtaxiaSubligar"))
                    {
                        return "AtaxiaMagic";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaCuisses"))
                    {
                        return "AuricTeslaMelee";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaHoodedFacemask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaPlumedHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaSpaceHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaWireHemmedVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("AuricTeslaCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("BloodflareHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BloodflareBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BloodflareCuisses"))
                    {
                        return "BloodflareRogue";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("BloodflareHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BloodflareBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BloodflareCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("BloodflareHornedHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BloodflareBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BloodflareCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("BloodflareHornedMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BloodflareBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BloodflareCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("BloodflareMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BloodflareBodyArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BloodflareCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("BrimflameScowl") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("BrimflameRobes") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("BrimflameBoots"))
                    {
                        return "Brimflame";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("DaedalusHat") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DaedalusBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DaedalusLeggings"))
                    {
                        return "DaedalusMagic";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("DaedalusHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DaedalusBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DaedalusLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("DaedalusHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DaedalusBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DaedalusLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("DaedalusHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DaedalusBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DaedalusLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("DaedalusVisor") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DaedalusBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DaedalusLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("DemonshadeHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DemonshadeBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DemonshadeGreaves"))
                    {
                        return "Demonshade";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("DesertProwlerHat") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("DesertProwlerShirt") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("DesertProwlerPants"))
                    {
                        return "DesertProwler";
                    }
                    
                    if (head.type == ModCompatibility.CalamityMod.ItemType("FearmongerGreathelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("FearmongerPlateMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("FearmongerGreaves"))
                    {
                        return "Fearmonger";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("FathomSwarmerVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("FathomSwarmerBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("FathomSwarmerBoots"))
                    {
                        return "FathomSwarmer";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("GodSlayerHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("GodSlayerChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("GodSlayerLeggings"))
                    {
                        return "GodSlayerMelee";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("GodSlayerHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("GodSlayerChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("GodSlayerLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("GodSlayerHornedHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("GodSlayerChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("GodSlayerLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("GodSlayerMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("GodSlayerChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("GodSlayerLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("GodSlayerVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("GodSlayerChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("GodSlayerLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("MolluskShellmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("MolluskShellplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("MolluskShelleggings"))
                    {
                        return "Mollusk";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("OmegaBlueHelmet") ||
                        body.type == ModCompatibility.CalamityMod.ItemType("OmegaBlueChestplate") ||
                        legs.type == ModCompatibility.CalamityMod.ItemType("OmegaBlueLeggings"))
                    {
                        return "OmegaBlue";
                    }
                    
                    if (head.type == ModCompatibility.CalamityMod.ItemType("PlagueReaperMask") ||
                        body.type == ModCompatibility.CalamityMod.ItemType("PlagueReaperVest") ||
                        legs.type == ModCompatibility.CalamityMod.ItemType("PlagueReaperStriders"))
                    {
                        return "PlagueReaper";
                    }
                    
                    if (head.type == ModCompatibility.CalamityMod.ItemType("PrismaticHelmet") ||
                        body.type == ModCompatibility.CalamityMod.ItemType("PrismaticRegalia") ||
                        legs.type == ModCompatibility.CalamityMod.ItemType("PrismaticGreaves"))
                    {
                        return "Prismatic";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("PlaguebringerVisor") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("PlaguebringerCarapace") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("PlaguebringerPistons"))
                    {
                        return "Plaguebringer";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("ReaverCap") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("ReaverScaleMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("ReaverCuisses"))
                    {
                        return "ReaverRogue";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("ReaverHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("ReaverScaleMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("ReaverCuisses"))
                    {
                        return "ReaverMelee";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("ReaverHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("ReaverScaleMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("ReaverCuisses"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("ReaverMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("ReaverScaleMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("ReaverCuisses"))
                    {
                        return "ReaverMagic";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("ReaverVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("ReaverScaleMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("ReaverCuisses"))
                    {
                        return "ReaverRanged";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SilvaHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SilvaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SilvaLeggings"))
                    {
                        return "SilvaMelee";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("SilvaHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SilvaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SilvaLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SilvaHornedHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SilvaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SilvaLeggings"))
                    {
                        return "SilvaRanged";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SilvaMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SilvaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SilvaLeggings"))
                    {
                        return "SilvaRogue";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SilvaMaskedCap") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SilvaArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SilvaLeggings"))
                    {
                        return "SilvaMagic";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SnowRuffianMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SnowRuffianChestplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SnowRuffianGreaves"))
                    {
                        return "SnowRuffian";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("StatigelCap") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("StatigelArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("StatigelGreaves"))
                    {
                        return "StatigelMagic";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("StatigelHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("StatigelArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("StatigelGreaves"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("StatigelHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("StatigelArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("StatigelGreaves"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("StatigelHood") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("StatigelArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("StatigelGreaves"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("StatigelMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("StatigelArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("StatigelGreaves"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("SulfurHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("SulfurBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("SulfurLeggings"))
                    {
                        return "Sulfur";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("TarragonHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TarragonBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TarragonLeggings"))
                    {
                        return "TarragonMelee";
                    }
                    
                    if (head.type == ModCompatibility.CalamityMod.ItemType("TarragonHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TarragonBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TarragonLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("TarragonHornedHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TarragonBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TarragonLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("TarragonMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TarragonBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TarragonLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("TarragonVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TarragonBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TarragonLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("TitanHeartMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("TitanHeartMantle") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("TitanHeartBoots"))
                    {
                        return "TitanHeart";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("UmbraphileHood") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("UmbraphileRegalia") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("UmbraphileBoots"))
                    {
                        return "Umbraphile";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("VictideHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("VictideBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("VictideLeggings"))
                    {
                        return "VictideRogue";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("VictideHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("VictideBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("VictideLeggings"))
                    {
                        return "VictideMelee";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("VictideHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("VictideBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("VictideLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("VictideMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("VictideBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("VictideLeggings"))
                    {
                        return "VictideMagic";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("VictideVisage") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("VictideBreastplate") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("VictideLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("WulfrumHeadgear") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("WulfrumArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("WulfrumLeggings"))
                    {
                        return "WulfrumRanged";
                    }

                    if (head.type == ModCompatibility.CalamityMod.ItemType("WulfrumHelm") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("WulfrumArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("WulfrumLeggings"))
                    {
                        return "WulfrumMelee";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("WulfrumHelmet") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("WulfrumArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("WulfrumLeggings"))
                    {
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("WulfrumHood") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("WulfrumArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("WulfrumLeggings"))
                    {
                        return "WulfrumMagic";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("WulfrumMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("WulfrumArmor") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("WulfrumLeggings"))
                    {
                        return "WulfrumRogue";
                    ...
                    if (head.type == ModCompatibility.CalamityMod.ItemType("XerocMask") &&
                        body.type == ModCompatibility.CalamityMod.ItemType("XerocPlateMail") &&
                        legs.type == ModCompatibility.CalamityMod.ItemType("XerocCuisses"))
                    {
                        return "Xeroc";
                    }
                }
        ...
        public override void UpdateArmorSet(Player player, string set)
        {
            if (ModCompatibility.CalamityMod != null && LanguageManager.Instance.ActiveCulture == GameCulture.Russian)
            {
                if (CalamityRuTranslate.TRuConfig.CalamityTranslation)
                {
                    ...
                    {
                        case "Obsidian":
                            player.setBonus = ModCompatibility.DeathMode ? 
