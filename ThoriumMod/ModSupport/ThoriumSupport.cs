...
namespace CalamityRuTranslate.ThoriumMod.ModSupport
{
	public class ThoriumSupport
	{
		...
		public static void ThoriumBardClass()
		{
			for (int i = 0; i < 100; i++)
			{
				if (Main.combatText[i].text == "+3% attack speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+3% скорости атаки";
				}
				if (Main.combatText[i].text == "+6% attack speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+6% скорости атаки";
				}
				if (Main.combatText[i].text == "+9% attack speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+9% скорости атаки";
				}
				if (Main.combatText[i].text == "+12% attack speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+12% скорости атаки";
				}
				if (Main.combatText[i].text == "+5% critical strike chance" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% шанс критического удара";
				}
				if (Main.combatText[i].text == "+10% critical strike chance" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% шанс критического удара";
				}
				if (Main.combatText[i].text == "+15% critical strike chance" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% шанс критического удара";
				}
				if (Main.combatText[i].text == "+20% critical strike chance" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% шанс критического удара";
				}
				if (Main.combatText[i].text == "+5% damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% урона";
				}
				if (Main.combatText[i].text == "+10% damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% урона";
				}
				if (Main.combatText[i].text == "+15% damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% урона";
				}
				if (Main.combatText[i].text == "+20% damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% урона";
				}
				if (Main.combatText[i].text == "+1 flat damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+1 плоского урона";
				}
				if (Main.combatText[i].text == "+2 flat damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+2 плоского урона";
				}
				if (Main.combatText[i].text == "+3 flat damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+3 плоского урона";
				}
				if (Main.combatText[i].text == "+4 flat damage" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+4 плоского урона";
				}
				if (Main.combatText[i].text == "+25% underwater breath & speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+25% подводное дыхание и скорость";
				}
				if (Main.combatText[i].text == "+50% underwater breath & speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+50% подводное дыхание и скорость";
				}
				if (Main.combatText[i].text == "+75% underwater breath & speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+75% подводное дыхание и скорость";
				}
				if (Main.combatText[i].text == "+100% underwater breath & speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+100% подводное дыхание и скорость";
				}
				if (Main.combatText[i].text == "+10% flight time" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% времени полета";
				}
				if (Main.combatText[i].text == "+20% flight time" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% времени полета";
				}
				if (Main.combatText[i].text == "+30% flight time" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+30% времени полета";
				}
				if (Main.combatText[i].text == "+40% flight time" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+40% времени полета";
				}
				if (Main.combatText[i].text == "+1 block of jump height" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+1 блок высоты прыжка";
				}
				if (Main.combatText[i].text == "+2 block of jump height" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+2 блока высоты прыжка";
				}
				if (Main.combatText[i].text == "+3 block of jump height" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+3 блока высоты прыжка";
				}
				if (Main.combatText[i].text == "+4 block of jump height" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+4 блока высоты прыжка";
				}
				if (Main.combatText[i].text == "+5% base and bonus movement speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% базовой и дополнительной скорости движения";
				}
				if (Main.combatText[i].text == "+10% base and bonus movement speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% базовой и дополнительной скорости движения";
				}
				if (Main.combatText[i].text == "+15% base and bonus movement speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% базовой и дополнительной скорости движения";
				}
				if (Main.combatText[i].text == "+20% base and bonus movement speed" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% базовой и дополнительной скорости движения";
				}
				if (Main.combatText[i].text == "+3% damage reduction" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+3% сопротивление урону";
				}
				if (Main.combatText[i].text == "+6% damage reduction" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+6% сопротивление урону";
				}
				if (Main.combatText[i].text == "+9% damage reduction" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+9% сопротивление урону";
				}
				if (Main.combatText[i].text == "+12% damage reduction" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+12% сопротивление урону";
				}
				if (Main.combatText[i].text == "+4 defense" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+4 защиты";
				}
				if (Main.combatText[i].text == "+8 defense" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+8 защиты";
				}
				if (Main.combatText[i].text == "+12 defense" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+12 защиты";
				}
				if (Main.combatText[i].text == "+16 defense" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+16 защиты";
				}
				if (Main.combatText[i].text == "+0,2  sec. of after hit invincibility" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+0,2 сек. неуязвимости";
				}
				if (Main.combatText[i].text == "+0,4  sec. of after hit invincibility" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+0,4 сек. неуязвимости";
				}
				if (Main.combatText[i].text == "+0,6  sec. of after hit invincibility" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+0,6 сек. неуязвимости";
				}
				if (Main.combatText[i].text == "+0,8  sec. of after hit invincibility" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+0,8 сек. неуязвимости";
				}
				if (Main.combatText[i].text == "+2 life/sec" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+2 здоровье/сек";
				}
				if (Main.combatText[i].text == "+4 life/sec" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+4 здоровье/сек";
				}
				if (Main.combatText[i].text == "+6 life/sec" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+6 здоровье/сек";
				}
				if (Main.combatText[i].text == "+8 life/sec" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+8 здоровье/сек";
				}
				if (Main.combatText[i].text == "+5% chance to not consume resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% шанс не использовать ресурс";
				}
				if (Main.combatText[i].text == "+10% chance to not consume resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% шанс не использовать ресурс";
				}
				if (Main.combatText[i].text == "+15% chance to not consume resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% шанс не использовать ресурс";
				}
				if (Main.combatText[i].text == "+20% chance to not consume resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% шанс не использовать ресурс";
				}
				if (Main.combatText[i].text == "+5% maximum resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% максимума ресурсов";
				}
				if (Main.combatText[i].text == "+10% maximum resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% максимума ресурсов";
				}
				if (Main.combatText[i].text == "+15% maximum resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% максимума ресурсов";
				}
				if (Main.combatText[i].text == "+20% maximum resource" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% максимума ресурсов";
				}
				if (Main.combatText[i].text == "x3 resource item grab range" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "x3 дальность захвата ресурсов";
				}
				if (Main.combatText[i].text == "x6 resource item grab range" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "x6 дальность захвата ресурсов";
				}
				if (Main.combatText[i].text == "x9 resource item grab range" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "x9 дальность захвата ресурсов";
				}
				if (Main.combatText[i].text == "x12 resource item grab range" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "x12 дальность захвата ресурсов";
				}
				if (Main.combatText[i].text == "+5% resource regeneration" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+5% регенерации ресурсов";
				}
				if (Main.combatText[i].text == "+10% resource regeneration" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+10% регенерации ресурсов";
				}
				if (Main.combatText[i].text == "+15% resource regeneration" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+15% регенерации ресурсов";
				}
				if (Main.combatText[i].text == "+20% resource regeneration" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+20% регенерации ресурсов";
				}
				if (Main.combatText[i].text == "+1 second" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+1 секунда";
				}
				if (Main.combatText[i].text == "+1,5 seconds" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+1,5 секунды";
				}
				if (Main.combatText[i].text == "+2 seconds" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+2 секунды";
				}
				if (Main.combatText[i].text == "+2,5 seconds" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "+2,5 секунды";
				}
				if (Main.combatText[i].text == "Freebie!" && Main.combatText[i].active)
				{
					Main.combatText[i].text = "Бесплатно!";
				}
			}
		}
		...
		public static void ThoriumNpcChat()
		{
			...
			{
				Main.npcChatText = "Ты уже спускался в акватические глубины? Его давящая атмосфера отпугивает многих исследователей, но я уверен, что ты найдешь способ обойти этот неприступный барьер...";
			}
