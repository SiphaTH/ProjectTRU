...
public class HatGirlPatch : OnPatcher
{
    ...
    private void Translation(SayThingWhileOwnerIsAliveDelegate orig, Player owner, string text)
    {
        text = text switch
        {
            "The Scourge will stop at nothing to snack on you! Stay on the move!" => "Бич не остановится ни перед чем, чтобы закусить тобой! Будь начеку!",
            "That thing seems to have shed its outer shell. Brace yourself, it's going to be a lot faster now!" => "Эта штука сбросила свою внешнюю оболочку. Готовься, теперь всё будет намного быстрее!",
            "Don't forget about that rubble! It will rain down from above!" => "Не забывай про булыжники! Они будут осыпаться сверху!",
            "Don't panic while trying to evade the bolts!" => "Не паникуй, пытаясь уклониться от зарядов!",
            "Stay near the center of your arena if you can. Those thorns are really good at cornering you!" => "Лучше всего держись ближе к центру арены. Эти шипы способны загнать тебя в угол!",
            "The beam predicts your position, try baiting it into shooting away from you!" => "Луч предугадывает твою позицию, попробуй заставить его выстрелить в сторону!",
            ...
            "Lightning is going to aim ahead of you! Try to bait it!" => "Молния старается бить впереди тебя! Попробуй обмануть её!",
            ...
            "Prepare for it's final stand! Watch for red laser telegraphs and prepare to dash to safety!" => "Готовься, осталось немного! Следи за красными лазерными телеграфами и готовься делать кучу рывков!",
            ...
            "Seems like they are combining efforts, beware!" => "Они объединяют усилия, берегись!",
            "Don't fret, face fear in the eyes and dash directly into Thanatos' face-plates!" => "Не бойся, посмотри страху в глаза и ринься прямо в лицевые пластины Танатоса!",
            "If a certain starting combo isnt working too well, maybe experiment with another one?" => "Если стартовое комбо работает не очень, то, может быть, попробовать другое?",
            "Better choose well!" => "Хорошенько подумай над выбором!",
            "Static bolts seem to be flying towards you! Be wary of them, and don't get trapped by the lightning telegraphs!" => "В твою сторону летят статические заряды! Будь осторожен с ними и не попадись в ловушку из молний!",
            ...
            "Home stretch! Do the same as you did before!" => "Ну, уже почти! Давай, делай то же самое, что делал раньше!",
            ...
            "Those drones are building a jail around you, destroying one will give you an opening!" => "Дроны строят вокруг тебя тюрьму, уничтожь один для открытия прохода!",
            ...
            "Polterghast's spirits have been released! But they don't seem very happy with us..." => "Духи Полтергаста были освобождены! Но, кажется, они нам не очень рады...",
            "Those blue tesla mines are going to explode into gas; take cover!" => "Эти синие мины сейчас взорвутся газом, прячься!",
            ...
            "Don't move around too quickly! Small but quick horizontal movements are important for evading those crystals!" => "Не двигайся слишком быстро! Небольшие, но быстрые горизонтальные движения важны для уклонения от кристаллов!",
            "Pay attention to where you move. You don't want Providence to fire her lasers when near a wall!" => "Внимательно следи за тем, куда двигаешься. Уж поверь, ты не хочешь, чтобы Провиденс стреляла из своих лазеров, когда ты рядом со стеной!",
            ...
            "So many skulls, but it appears they aren't focused directly at you! Try going inbetween!" => "Как много черепов, но, похоже, они не направлены прямо на тебя! Попробуй пройти между ними!",
            ...
            "Watch out, that last twin is gonna hit you with everything it's got! Don't let up!" => "Берегись, последний близнец ударит тебя со всей силы! Не останавливайся!",
            "Better stay near the edges of the arena during those carpet bomb flames, That should keep them out of the way!" => "Лучше во время ковровой бомбардировки огнями держись ближе к краям арены, так они будут меньше мешать!",
