...
namespace CalamityRuTranslate.Mods.Fargowiltas.NPCs
{
    ...
    {
        #region Properties
        private static int Abominationn => NPC.FindFirstNPC(CoreFargowiltasTranslation.Fargo.NPCType("Abominationn"));
        private static int Mutant => NPC.FindFirstNPC(CoreFargowiltasTranslation.Fargo.NPCType("Mutant"));
        private static int Deviantt => NPC.FindFirstNPC(CoreFargowiltasTranslation.Fargo.NPCType("Deviantt"));
        private static int LumberJack => NPC.FindFirstNPC(CoreFargowiltasTranslation.Fargo.NPCType("LumberJack"));
        private static int Squirrel => NPC.FindFirstNPC(CoreFargowiltasTranslation.Fargo.NPCType("Squirrel"));
            ...
            if (TalkingNpc == Abominationn)
            {
                switch (npcPhrase)
                {
                    case "Where'd I get my scythe from? Ask me later.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.1");
                        break;
                    case "Where'd I get my scythe from? You'll figure it out.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.2");
                        break;
                    case "I have defeated everything in this land... nothing can beat me.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.3");
                        break;
                    case "Have you ever had a weapon stuck to your hand? It's not very handy.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.4");
                        break;
                    case "What happened to Yoramur? No idea who you're talking about.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.5");
                        break;
                    case "You wish you could dress like me? Ha! Maybe in 2020.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.6");
                        break;
                    case "You ever read the ancient classics, I love all the fighting in them.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.7");
                        break;
                    case "I'm a world class poet, ever read my piece about impending doom?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.8");
                        break;
                    case "You want swarm summons? Maybe next year.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.9");
                        break;
                    case "Like my wings? Thanks, the thing I got them from didn't like it much.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.10");
                        break;
                    case "Heroism has no place in this world, instead let's just play ping pong.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.11");
                        break;
                    case "Why are you looking at me like that? Your fashion sense isn't going to be winning you any awards either.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.12");
                        break;
                    case "No, you can't have my hat.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.13");
                        break;
                    case "Embrace suffering... Wait what do you mean that's already taken?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.14");
                        break;
                    case "Your attempt to exploit my anger is admirable, but I cannot be angered.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.15");
                        break;
                    case "Is it really a crime if everyone else does it.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.16");
                        break;
                    case "Inflicting suffering upon others is the most amusing thing there is.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.17");
                        break;
                    case "Irony is the best kind of humor, isn't that ironic?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.18");
                        break;
                    case "I like Cat... What do you mean who's Cat?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.19");
                        break;
                    case "Check the wiki if you need anything, the kirb is slowly getting it up to par.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.20");
                        break;
                    case "I've heard tales of a legendary Diver... Anyway what was that about a giant jellyfish?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.21");
                        break;
                    case "Overloaded events...? Yeah, they're pretty cool.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.22");
                        break;
                    case "It's not like I don't enjoy your company, but can you buy something?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.23");
                        break;
                    case "I have slain one thousand humans! Huh? You're a human? There's so much blood on your hands..":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.24");
                        break;
                    case "I don't think there's an event right now.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.28");
                        break;
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.25"), Main.npc[Mutant].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.26"), Main.npc[Deviantt].GivenName);
                }
                
                if (Mechanic.IsExistingNPC() && npcPhrase == $"Can you please ask {Main.npc[Mechanic].GivenName} to stop touching my laser arm please.")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Abominationn.27"), Main.npc[Mechanic].GivenName);
                }
            ...
            else if (TalkingNpc == Deviantt)
            {
                switch (npcPhrase)
                {
                    case "The blood moon's effects? I'm not human anymore, so nope!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.1");
                        break;
                    case "Did you know? The only real music genres are death metal and artcore.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.2");
                        break;
                    case "I'll have you know I'm over a hundred Fargo years old! Don't ask me how long a Fargo year is.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.3");
                        break;
                    case "I might be able to afford a taller body if you keep buying!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.4");
                        break;
                    case "Where's that screm cat?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.5");
                        break;
                    case "You're the Terrarian? Honestly, I was expecting someone a little... taller.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.6");
                        break;
                    case "Don't look at me like that! The only thing I've deviated from is my humanity.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.7");
                        break;
                    case "Rip and tear and buy from me for more things to rip and tear!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.8");
                        break;
                    case "What's a chee-bee doe-goe?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.9");
                        break;
                    case "Wait a second. Are you sure this house isn't what they call 'prison?'":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.10");
                        break;
                    case "Deviantt has awoken! Quick, give her all your money to defeat her!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.11");
                        break;
                    case "One day, I'll sell a summon for myself! ...Just kidding.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.12");
                        break;
                    case "Hmm, I can tell! You've killed a lot, but you haven't killed enough!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.13");
                        break;
                    case "Why the extra letter, you ask? Only the strongest sibling is allowed to remove their own!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.14");
                        break;
                    case "The more rare things you kill, the more stuff I sell! Simple, right?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.15");
                        break;
                    case "Embrace suffering... and while you're at it, embrace another purchase!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.16");
                        break;
                    ...
                    case "Who do you think we are? We're parts of you, a few hundred million years from now after you shed the need for a physical body.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.20");
                        break;
                    case "Mutant is inhabiting the physical shell of your future self, but we're all manifestations of your power and experience.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.21");
                        break;
                    case "In our first past, it took you eons to amass power. Since we happened to come back, we decided to help speed it up a little!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.22");
                        break;
                    case "Even if the three of us joined forces again, we still wouldn't regain the full power of our original self. You could probably still beat us!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.23");
                        break;
                    case "To accelerate your growth, Mutant released his powers to the rest of the world. Good work gathering it all back for yourself!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.24");
                        break;
                    case "Don't worry about our true names. We don't actually have any!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.25");
                        break;
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.34"), Main.LocalPlayer.name);
                }
                ...
                if (Mutant.IsExistingNPC())
                {
                    ...
                    {
                        npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.35"), Main.npc[Mutant].GivenName);
                    }
                    else if (npcPhrase == $"One day, I'll sell a summon for myself! ...Just kidding. That's {Main.npc[Mutant].GivenName}'s job.")
                    {
                        npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.36"), Main.npc[Mutant].GivenName);
                    }
                    else if (npcPhrase == $"{Main.npc[Mutant].GivenName} is here! That's my big brother!")
                    {
                        npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.37"), Main.npc[Mutant].GivenName);
                    }
                }

                if (Abominationn.IsExistingNPC() && npcPhrase == $"{Main.npc[Abominationn].GivenName} is here! That's my big-but-not-biggest brother!")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.38"), Main.npc[Abominationn].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.39"), Main.npc[LumberJack].GivenName);
                }
                
                if (Angler.IsExistingNPC() && npcPhrase == $"Have you ever considered throwing {Main.npc[Angler].GivenName} back where you found him?")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Deviantt.40"), Main.npc[Angler].GivenName);
                }
            }
            else if (TalkingNpc == LumberJack)
            {
                switch (npcPhrase)
                {
                    case "Dynasty wood? Between you and me, that stuff ain't real wood!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.1");
                        break;
                    case "Sure cactus isn't wood, but I can still chop it with me trusty axe.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.2");
                        break;
                    case "You wouldn't by chance have any fantasies about me... right?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.3");
                        break;
                    case "I eat a bowl of woodchips for breakfast... without any milk.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.4");
                        break;
                    case "TIIIIIIIIIMMMBEEEEEEEERRR!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.5");
                        break;
                    case "I'm a lumberjack and I'm okay, I sleep all night and I work all day!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.6");
                        break;
                    case "You won't ever need an axe again with me around.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.7");
                        break;
                    case "I have heard of people cutting trees with fish, who does that?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.8");
                        break;
                    case "You wanna see me work without my shirt on? Maybe in 2030.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.9");
                        break;
                    case "You ever seen the world tree?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.10");
                        break;
                    case "You want what? ...Sorry that's not the kind of wood I'm selling.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.11");
                        break;
                    case "Why don't I sell acorns? ...I replant all the trees I chop, don't you?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.12");
                        break;
                    case "What's the best kind of tree? ... Any if I can chop it.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.13");
                        break;
                    case "Can I axe you a question?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.14");
                        break;
                    case "Might take a nap under a tree later, care to join me?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.15");
                        break;
                    case "I'm an expert in all wood types.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.16");
                        break;
                    case "I wonder if there'll be more trees to chop in 1.4.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.17");
                        break;
                    case "Red is one of my favourite colors, right after wood.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.18");
                        break;
                    case "It's always flannel season.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.19");
                        break;
                    case "I'm glad my wood put such a big smile on your face.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.20");
                        break;
                    case "Astroturf? Sorry I only grow trees on real grass.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.21");
                        break;
                    case "Yew tree? Sakura tree? Nope, haven't found any.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.22");
                        break;
                    case "While I was chopping down a cactus these things leaped at me, why don't you take care of them?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.23");
                        break;
                    case "These mahogany trees are full of life, but a tree only has one purpose: to be chopped. Oh yea this fell out of the last one.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.24");
                        break;
                    case "This place is a bit fanciful for my tastes, but the wood's as choppable as any. Nighttime has these cool bugs though, take a few.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.25");
                        break;
                    case "Whatever causes these to glow is beyond me, you're probably gonna eat them anyway so have this while youre at it.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.26");
                        break;
                    ...
                    case "Chopping trees at night is always relaxing... well except for the flying eyeballs. Have one of these little guys to keep you company.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.30");
                        break;
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.33"), Main.npc[Dryad].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.LumberJack.34"), Main.npc[Nurse].GivenName);
                }
            }
            else if (TalkingNpc == Mutant)
            {
                switch (npcPhrase)
                {
                    case "Savagery, barbarism, bloodthirst, that's what I like seeing in people.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.1");
                        break;
                    case "The stronger you get, the more stuff I sell. Makes sense, right?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.2");
                        break;
                    case "There's something all of you have that I don't... Death perception, I think it's called?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.3");
                        break;
                    case "It would be pretty cool if I sold a summon for myself...":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.4");
                        break;
                    case "The only way to get stronger is to keep buying from me and in bulk too!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.5");
                        break;
                    case "Why are you looking at me like that, all I did was eat an apple.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.6");
                        break;
                    case "Don't bother with anyone else, all you'll ever need is right here.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.7");
                        break;
                    case "You're lucky I'm on your side.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.8");
                        break;
                    case "Thanks for the house, I guess.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.9");
                        break;
                    case "Why yes I would love a ham and swiss sandwich.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.10");
                        break;
                    case "Should I start wearing clothes? ...Nah.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.11");
                        break;
                    case "It's not like I can actually use all the gold you're spending.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.12");
                        break;
                    case "Violence for violence is the law of the beast.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.13");
                        break;
                    case "Those guys really need to get more creative. All of their first bosses are desert themed!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.14");
                        break;
                    case "You say you want to know how a Mutant and Abominationn are brothers? You're better off not knowing.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.15");
                        break;
                    case "I'm all you need for a calamity.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.16");
                        break;
                    case "Everything shall bow before me! ...after you make this purchase.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.17");
                        break;
                    case "It's clear that I'm helping you out, but uh.. what's in this for me? A house you say? I eat zombies for breakfast.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.18");
                        break;
                    case "Can I jump? No, I don't have something called a 'spacebar'.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.19");
                        break;
                    case "Got your nose, I needed one to replace mine.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.20");
                        break;
                    case "What's a Terry?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.21");
                        break;
                    case "Why do so many creatures carry around a weird looking blue doll? The world may never know.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.22");
                        break;
                    case "Impending doom approaches. ...If you don't buy anything of course.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.23");
                        break;
                    case "I've heard of a '3rd dimension', I wonder what that looks like.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.24");
                        break;
                    case "Boy don't I look fabulous today.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.25");
                        break;
                    case "You have fewer friends than I do eyes.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.26");
                        break;
                    case "The ocean is a dangerous place, I wonder where Diver is?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.27");
                        break;
                    case "Do you know what an Ee-arth is?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.28");
                        break;
                    case "I can't even spell 'apotheosis', do you expect me to know what it is?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.29");
                        break;
                    case "Where do monsters get their gold from? ...I don't have pockets you know.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.30");
                        break;
                    case "Dogs are cool and all, but cats don't try to bite my brain.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.31");
                        break;
                    case "Beware the green dragon... What's that face mean?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.32");
                        break;
                    case "Where is this O-hi-o I keep hearing about.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.33");
                        break;
                    case "I've told you 56 times already, I'm busy... Oh wait you want to buy something, I suppose I have time.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.34");
                        break;
                    case "I've heard of a 'Soul of Souls' that only exists in 2015.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.35");
                        break;
                    case "Adding EX after everything makes it way more difficult.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.36");
                        break;
                    case "I think that all modern art looks great, especially the bloody stuff.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.37");
                        break;
                    case "How many guides does it take to change a lightbulb? ... I don't know, how about you ask him.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.38");
                        break;
                    case "Good thing I don't have a bed, I'd probably never leave it.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.39");
                        break;
                    case "What's this about an update? Sounds rare.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.40");
                        break;
                    case "If you need me I'll be slacking off somewhere.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.41");
                        break;
                    case "What do you mean who is Fargo!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.42");
                        break;
                    case "Have you seen the ech cat?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.43");
                        break;
                    case "I don't understand music nowadays, I prefer some smooth jazz... or the dying screams of monsters.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.44");
                        break;
                    case "Cthulhu's got nothing on me!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.45");
                        break;
                    case "Now that you've defeated the big guy, I'd say it's time to start collecting those materials!":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.46");
                        break;
                    case "What's that? You want to fight me? ...sure, I guess.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.47");
                        break;
                    case "What's that? You want to fight me? ...maybe if I had a reason.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.48");
                        break;
                    case "What's that? You want to fight me? ...you're not worthy you rat.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.49");
                        break;
                    case "Why would you do this.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.50");
                        break;
                    case "I feel a great imbalance in this world.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.51");
                        break;
                    case "A great choice, shame about that first desert boss thing though.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.52");
                        break;
                    case "A bit spooky tonight, isn't it.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.53");
                        break;
                    case "I'd ask for a coat, but I don't think you have any my size.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.54");
                        break;
                    case "Weather seems odd today, wouldn't you agree?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.55");
                        break;
                    case "Lovely night, isn't it?":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.56");
                        break;
                    case "I hope the constant arguing I'm hearing isn't my fault.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.57");
                        break;
                    case "I'd follow and help, but I'd much rather sit around right now.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.58");
                        break;
                    case "I don't know what everyone's so happy about, but as long as nobody mistakes me for a Pigronata, I'm happy too.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.59");
                        break;
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.60"), Main.npc[PartyGirl].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.62"), Main.npc[Nurse].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.63"), Main.npc[WitchDoctor].GivenName);
                }
                
                if (Dryad.IsExistingNPC() && npcPhrase == $"Why does {Main.npc[Dryad].GivenName}'s outfit make my wings flutter?")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.64"), Main.npc[Dryad].GivenName);
                }
                
                if (Stylist.IsExistingNPC() && npcPhrase == $"{Main.npc[Stylist].GivenName} once gave me a wig... I look hideous with long hair.")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.65"), Main.npc[Stylist].GivenName);
                }
                
                if (Truffle.IsExistingNPC() && npcPhrase == "That mutated mushroom seems like my type of fella.")
                {
                    npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.66");
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.67"), Main.npc[TaxCollector].GivenName);
                }
                
                if (Guide.IsExistingNPC() && npcPhrase == $"Any idea why {Main.npc[Guide].GivenName} is always cowering in fear when I get near him?")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.68"), Main.npc[Guide].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.69"), Main.npc[WitchDoctor].GivenName, Main.npc[Truffle].GivenName, Main.npc[Cyborg].GivenName);
                }
                
                if (PartyGirl.IsExistingNPC() && npcPhrase == $"Man, {Main.npc[PartyGirl].GivenName}'s confetti keeps getting stuck to my wings")
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.70"), Main.npc[PartyGirl].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.71"), Main.npc[Demolitionist].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.72"), Main.npc[DD2Bartender].GivenName);
                }
                ...
                {
                    npcPhrase = string.Format(LangUtilities.TranslationKey("Fargo.NpcChatText.Mutant.73"), Main.npc[DyeTrader].GivenName);
                }
            }
            else if (TalkingNpc == Squirrel)
            {
                switch (npcPhrase)
                {
                    case "You will suffer.":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Squirrel.1");
                        break;
                    case "*squeak*":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Squirrel.2");
                        break;
                    case "*chitter*":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Squirrel.3");
                        break;
                    case "*crunch crunch*":
                        npcPhrase = LangUtilities.TranslationKey("Fargo.NpcChatText.Squirrel.4");
                        break;
                }
            }
