...
namespace CalamityRuTranslate.ThoriumMod.Tiles
{
	internal class ThoriumTiles
	{
		...
		{
			ModTile tile = TileLoader.GetTile(ModsCall.Thorium.TileType("Altar"));
			...
			ModTile tile2 = TileLoader.GetTile(ModsCall.Thorium.TileType("Aquaite"));
			...
			ModTile tile3 = TileLoader.GetTile(ModsCall.Thorium.TileType("AquaticDepthsBanner"));
			...
			ModTile tile4 = TileLoader.GetTile(ModsCall.Thorium.TileType("AquaticDepthsBiomeChest"));
			...
			ModTile tile5 = TileLoader.GetTile(ModsCall.Thorium.TileType("AquaticDepthsBiomeChest"));
			...
			ModTile tile6 = TileLoader.GetTile(ModsCall.Thorium.TileType("ArcaneArmorFabricator"));
			...
			ModTile tile7 = TileLoader.GetTile(ModsCall.Thorium.TileType("BloodAltar"));
			...
			ModTile tile8 = TileLoader.GetTile(ModsCall.Thorium.TileType("BloodSplatterTile"));
			...
			ModTile tile9 = TileLoader.GetTile(ModsCall.Thorium.TileType("ChessBlock"));
			...
			ModTile tile10 = TileLoader.GetTile(ModsCall.Thorium.TileType("CookTiles1"));
			...
			ModTile tile11 = TileLoader.GetTile(ModsCall.Thorium.TileType("CookTiles2"));
			...
			ModTile tile12 = TileLoader.GetTile(ModsCall.Thorium.TileType("CookTiles3"));
			...
			ModTile tile123 = TileLoader.GetTile(ModsCall.Thorium.TileType("CursedBlock"));
			...
			ModTile tile124 = TileLoader.GetTile(ModsCall.Thorium.TileType("CursedChest"));
			...
			ModTile tile13 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthChestTile"));
			...
			ModTile tile14 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsAmber"));
			...
			ModTile tile15 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsAmethyst"));
			...
			ModTile tile16 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsDiamond"));
			...
			ModTile tile17 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsEmerald"));
			...
			ModTile tile18 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsOnyx"));
			...
			ModTile tile19 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsOpal"));
			...
			ModTile tile20 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsRuby"));
			...
			ModTile tile21 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsSapphire"));
			...
			ModTile tile22 = TileLoader.GetTile(ModsCall.Thorium.TileType("DepthsTopaz"));
			...
			ModTile tile23 = TileLoader.GetTile(ModsCall.Thorium.TileType("DesertBiomeChest"));
			...
			ModTile tile24 = TileLoader.GetTile(ModsCall.Thorium.TileType("DesertBiomeChest"));
			...
			ModTile tile25 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureBathtub"));
			...
			ModTile tile26 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureBed"));
			...
			ModTile tile27 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureBookcase"));
			...
			ModTile tile28 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureCandelabra"));
			...
			ModTile tile29 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureCandle"));
			...
			ModTile tile30 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureChair"));
			...
			ModTile tile31 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureChandelier"));
			...
			ModTile tile32 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureClock"));
			...
			ModTile tile125 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureCup"));
			...
			ModTile tile33 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDoorClosed"));
			...
			ModTile tile34 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDoorOpen"));
			...
			ModTile tile35 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile36 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile37 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile38 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile39 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile40 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile41 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile42 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile126 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile127 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile128 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile129 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile400 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureDresser"));
			...
			ModTile tile43 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureLamp"));
			...
			ModTile tile44 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureLantern"));
			...
			ModTile tile45 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureMusicBox"));
			...
			ModTile tile46 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurniturePiano"));
			...
			ModTile tile47 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureSink"));
			...
			ModTile tile48 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureSofa"));
			...
			ModTile tile49 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureTable"));
			...
			ModTile tile130 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureToilet"));
			...
			ModTile tile50 = TileLoader.GetTile(ModsCall.Thorium.TileType("FurnitureWorkbench"));
			...
			ModTile tile51 = TileLoader.GetTile(ModsCall.Thorium.TileType("GingerbreadBlock"));
			...
			ModTile tile52 = TileLoader.GetTile(ModsCall.Thorium.TileType("GrayDPainting"));
			...
			ModTile tile53 = TileLoader.GetTile(ModsCall.Thorium.TileType("GrimPedestal"));
			...
			ModTile tile54 = TileLoader.GetTile(ModsCall.Thorium.TileType("GrimPedestal"));
			...
			ModTile tile55 = TileLoader.GetTile(ModsCall.Thorium.TileType("OrnateChest"));
			...
			ModTile tile56 = TileLoader.GetTile(ModsCall.Thorium.TileType("IllumiteChunk"));
			...
			ModTile tile57 = TileLoader.GetTile(ModsCall.Thorium.TileType("JungleFlower1"));
			...
			ModTile tile58 = TileLoader.GetTile(ModsCall.Thorium.TileType("JungleFlower2"));
			...
			ModTile tile59 = TileLoader.GetTile(ModsCall.Thorium.TileType("JungleFlower3"));
			...
			ModTile tile60 = TileLoader.GetTile(ModsCall.Thorium.TileType("JungleFlower4"));
			...
			ModTile tile61 = TileLoader.GetTile(ModsCall.Thorium.TileType("LargeCoral"));
			...
			ModTile tile62 = TileLoader.GetTile(ModsCall.Thorium.TileType("LifeCrystal"));
			...
			ModTile tile63 = TileLoader.GetTile(ModsCall.Thorium.TileType("LifeQuartz"));
			...
			ModTile tile64 = TileLoader.GetTile(ModsCall.Thorium.TileType("LivingLeafBush"));
			...
			ModTile tile65 = TileLoader.GetTile(ModsCall.Thorium.TileType("LodeStone"));
			...
			ModTile tile66 = TileLoader.GetTile(ModsCall.Thorium.TileType("LodestoneChest"));
			...
			ModTile tile67 = TileLoader.GetTile(ModsCall.Thorium.TileType("MagmaOre"));
			...
			ModTile tile68 = TileLoader.GetTile(ModsCall.Thorium.TileType("MarineChest"));
			...
			ModTile tile69 = TileLoader.GetTile(ModsCall.Thorium.TileType("MediciteBrick"));
			...
			ModTile tile70 = TileLoader.GetTile(ModsCall.Thorium.TileType("MistletoeTile"));
			...
			ModTile tile71 = TileLoader.GetTile(ModsCall.Thorium.TileType("MonsterBannerCave"));
			...
			ModTile tile72 = TileLoader.GetTile(ModsCall.Thorium.TileType("MonsterBannerJungle"));
			...
			ModTile tile73 = TileLoader.GetTile(ModsCall.Thorium.TileType("MonsterBannerSky"));
			...
			ModTile tile74 = TileLoader.GetTile(ModsCall.Thorium.TileType("MonsterBannerSpider"));
			...
			ModTile tile131 = TileLoader.GetTile(ModsCall.Thorium.TileType("NagaChest"));
			...
			ModTile tile75 = TileLoader.GetTile(ModsCall.Thorium.TileType("OceanCrystal"));
			...
			ModTile tile76 = TileLoader.GetTile(ModsCall.Thorium.TileType("Onyx"));
			...
			ModTile tile77 = TileLoader.GetTile(ModsCall.Thorium.TileType("OnyxTorch"));
			...
			ModTile tile78 = TileLoader.GetTile(ModsCall.Thorium.TileType("Opal"));
			...
			ModTile tile79 = TileLoader.GetTile(ModsCall.Thorium.TileType("OpalTorch"));
			...
			ModTile tile80 = TileLoader.GetTile(ModsCall.Thorium.TileType("PaintTileHuge"));
			...
			ModTile tile81 = TileLoader.GetTile(ModsCall.Thorium.TileType("PaintTileLarge"));
			...
			ModTile tile82 = TileLoader.GetTile(ModsCall.Thorium.TileType("PaintTileMedium"));
			...
			ModTile tile83 = TileLoader.GetTile(ModsCall.Thorium.TileType("PaintTileSmall"));
			...
			ModTile tile84 = TileLoader.GetTile(ModsCall.Thorium.TileType("PaintTileTall"));
			...
			ModTile tile85 = TileLoader.GetTile(ModsCall.Thorium.TileType("PearlStone"));
			...
			ModTile tile86 = TileLoader.GetTile(ModsCall.Thorium.TileType("PermafrostChest"));
			...
			ModTile tile87 = TileLoader.GetTile(ModsCall.Thorium.TileType("PlacedGem"));
			...
			ModTile tile88 = TileLoader.GetTile(ModsCall.Thorium.TileType("PlacedGem"));
			...
			ModTile tile89 = TileLoader.GetTile(ModsCall.Thorium.TileType("PlacedGem"));
			...
			ModTile tile90 = TileLoader.GetTile(ModsCall.Thorium.TileType("PlateChest"));
			...
			ModTile tile91 = TileLoader.GetTile(ModsCall.Thorium.TileType("RecipeCatalog"));
			...
			ModTile tile92 = TileLoader.GetTile(ModsCall.Thorium.TileType("SakuraSapling"));
			...
			ModTile tile93 = TileLoader.GetTile(ModsCall.Thorium.TileType("ScarletChest"));
			...
			ModTile tile132 = TileLoader.GetTile(ModsCall.Thorium.TileType("ShadyChest"));
			...
			ModTile tile94 = TileLoader.GetTile(ModsCall.Thorium.TileType("SmoothCoal"));
			...
			ModTile tile95 = TileLoader.GetTile(ModsCall.Thorium.TileType("SoulForge"));
			...
			ModTile tile96 = TileLoader.GetTile(ModsCall.Thorium.TileType("SpookySapling"));
			...
			ModTile tile97 = TileLoader.GetTile(ModsCall.Thorium.TileType("StrangeCrate"));
			...
			ModTile tile98 = TileLoader.GetTile(ModsCall.Thorium.TileType("StrangePlatingTile"));
			...
			ModTile tile99 = TileLoader.GetTile(ModsCall.Thorium.TileType("SugarCookieBlock"));
			...
			ModTile tile100 = TileLoader.GetTile(ModsCall.Thorium.TileType("SynthGold"));
			...
			ModTile tile101 = TileLoader.GetTile(ModsCall.Thorium.TileType("SynthPlatinum"));
			...
			ModTile tile102 = TileLoader.GetTile(ModsCall.Thorium.TileType("ThoriumAnvil"));
			...
			ModTile tile103 = TileLoader.GetTile(ModsCall.Thorium.TileType("ThoriumChest"));
			...
			ModTile tile104 = TileLoader.GetTile(ModsCall.Thorium.TileType("ThoriumOre"));
			...
			ModTile tile105 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrackerBoardTile"));
			...
			ModTile tile106 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile107 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile108 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile109 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile110 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile111 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile112 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile113 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile114 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile115 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile116 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile133 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile134 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile135 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile136 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile137 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile401 = TileLoader.GetTile(ModsCall.Thorium.TileType("TrappedChests"));
			...
			ModTile tile117 = TileLoader.GetTile(ModsCall.Thorium.TileType("Trophies"));
			...
			ModTile tile118 = TileLoader.GetTile(ModsCall.Thorium.TileType("UnderworldChest"));
			...
			ModTile tile119 = TileLoader.GetTile(ModsCall.Thorium.TileType("UnderworldChest"));
			...
			ModTile tile138 = TileLoader.GetTile(ModsCall.Thorium.TileType("ValadiumChest"));
			...
			ModTile tile120 = TileLoader.GetTile(ModsCall.Thorium.TileType("ValadiumChunk"));
			...
			ModTile tile121 = TileLoader.GetTile(ModsCall.Thorium.TileType("YewChest"));
			...
			ModTile tile122 = TileLoader.GetTile(ModsCall.Thorium.TileType("YewSapling"));
