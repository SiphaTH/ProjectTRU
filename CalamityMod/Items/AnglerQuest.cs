	...
	public class AnglerQuest : GlobalItem
	{
		public override void AnglerChat(int type, ref string chat, ref string catchLocation)
		{
			if (ModCompatibility.CalamityMod != null && LanguageManager.Instance.ActiveCulture == GameCulture.Russian)
			{
				...
				{
					if (type == ModCompatibility.CalamityMod.ItemType("EutrophicSandfish"))
					{
					...
					if (type == ModCompatibility.CalamityMod.ItemType("Serpentuna"))
					{
					...
					if (type == ModCompatibility.CalamityMod.ItemType("SurfClam"))
					{
					...
					if (type == ModCompatibility.CalamityMod.ItemType("Brimlish"))
					{
					...
					if (type == ModCompatibility.CalamityMod.ItemType("Slurpfish"))
					{
