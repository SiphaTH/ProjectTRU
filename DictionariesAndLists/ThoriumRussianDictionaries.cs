    ...
    public static class ThoriumRussianDictionaries
    {
        ...
        public static void LoadDictionaries()
        {
            ThoriumBuffs = new Dictionary<string, (string, string)>
            {
                ...
                {"GraniteSurge", ("Гранитный скачок", "Переполнение энергией наносит вашему телу урон и снижает защиту")},
                ...
                {"IlluminatedNPC", ("Подсвеченный", "Этот враг горит приятным светом")},
                ...
                {"Sunder", ("Расколотый", "Защита значительно уменьшена")},
                ...
                {"QuickRecovery", ("Быстрое восстановление", "Скорость восстановления здоровья увеличено на 25%")},
