...
public class CalamityTownNpcNames : GlobalNPC
{
    ...
    public override void ModifyNPCNameList(NPC npc, List<string> nameList)
    {
        ...
        {
            nameList.Clear();
            nameList.AddRange(new[] { "Иксплиззи", "Причуда", "Калдер", "Лаура", "Миэ", "Бонни", "Сара", "Диана", "Кейт", "Пенелопа", "Мариса", "Марибель", "Валери", "Джессика", "Роуэн", "Джесси", "Джейд", "Хин", "Эмбер", "Энн", "Индиана" });
        }
