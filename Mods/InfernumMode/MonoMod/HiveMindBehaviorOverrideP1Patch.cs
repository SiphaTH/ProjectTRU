...
public class HiveMindBehaviorOverrideP1Patch : OnPatcher
{
    ...
    public override MethodInfo ModifiedMethod => typeof(HiveMindBehaviorOverrideP1).GetCachedMethod(nameof(HiveMindBehaviorOverrideP1.GetTips));

    private delegate IEnumerable<Func<NPC, string>> GetTipsDelegate(HiveMindBehaviorOverrideP1 self);
