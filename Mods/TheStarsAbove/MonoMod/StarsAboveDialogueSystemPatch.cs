...
//         TranslationHelper.ModifyIL(il, "I've added the 'Bifrost' to your inventory. There's a lot to go over, but in short, it'll let you traverse the galaxy when used. We can talk more about it later.", "Я добавила в твой инвентарь Биврёст. Не буду томить тебя разговорами, буду краткой - при использовании он позволяет путешествовать по галактике. О нём мы поговорим позже.");
//         TranslationHelper.ModifyIL(il, "Also, I'll supply you with Essences when I can. Think of them as memories of other worlds. You can combine them with materials to create powerful Aspected Weapons.", "Ещё, когда смогу, я буду снабжать тебя Эссенциями. Думай о них, как о воспоминаниях иных миров. Ты можешь соединить их с материалами и создать мощные оружия Астр.");
...
//         TranslationHelper.ModifyIL(il, "It's nice to meet you. My name is Eridani.. a Starfarer. You, in turn, are my Starbearer.", "Приятно познакомиться. Меня зовут Эридани... Астра. Это, в свою очередь, делает тебя моим Звездоносцем.");
//         TranslationHelper.ModifyIL(il, "Through this contract, we must work together to bring justice to those willing to harm this world.", "Заключая этот контракт, мы должны работать сообща, и нести справедливость тем, кто стремится навредить этому миру.");
//         TranslationHelper.ModifyIL(il, "You can use the Spatial Disk I've given you to access the Stellar Array. It will become stronger after defeating bosses, and will grant you strength in return.", "Ты можешь использовать Пространственный диск, что я дала тебе, для получения доступа к Созвездиям. Победы над боссам сделают их сильнее, а в ответ они даруют свою силу.");
//         TranslationHelper.ModifyIL(il, "I've added the Bifrost to your inventory. At a later date, I can explain what it does, but in short, it will allow traversal of the universe.", "Я добавила в твой инвентарь Биврёст. Скоро я объясню что он делает, но если кратко - он позволяет путешествовать по галактике.");
//         TranslationHelper.ModifyIL(il, "Furthermore, I will grant you Essences. Essences are otherworldy memories that you can combine with this world's materials to forge Aspected Weapons.", "Кроме того, я буду снабжать тебя Эссенциями. Эссенции - воспоминания миров других, что ты можешь соединить с материалами этого, и создать оружия Астр.");
//         TranslationHelper.ModifyIL(il, "My strength is yours... I will not let you down.", "Моя сила - твоя... Я не подведу.");
//         TranslationHelper.ModifyIL(il, "Sorry, ", "Прости, ");
//         TranslationHelper.ModifyIL(il, ". Nothing to comment on right now.", ". Сейчас мне нечего сказать.");
//         TranslationHelper.ModifyIL(il, "Sorry, there's not much on my mind as of late.", "Прости, в последнее время мне нечего сказать.");
//         TranslationHelper.ModifyIL(il, "Apologies, ", "Приношу извинения, ");
//         TranslationHelper.ModifyIL(il, ".. there's not much to comment on at the moment.", ", сейчас мне нечего сказать.");
//         TranslationHelper.ModifyIL(il, "Sorry. There's not much to say right now...", "Извиняюсь, сейчас мне нечего сказать...");
//         TranslationHelper.ModifyIL(il, "My sister likely despises the undead rising every night.", "Моя сестра все эти ночные восстания нежити просто ненавидит.");
//         TranslationHelper.ModifyIL(il, "What about me? ", "Моё мнение?");
//         TranslationHelper.ModifyIL(il, "As long as they have money, it's a benefit to us, right?", "Деньги сами идут к нам в руки, а деньги всегда полезны, верно?");
//         TranslationHelper.ModifyIL(il, "Those disgusting creatures rising from the earth every night...", "Отвратительные существа, поднимающиеся каждую ночь из земли...");
//         TranslationHelper.ModifyIL(il, "Ew. Let's dispatch of them quickly. And- be mindful of your hygiene after.", "Мерзость. Давай избавимся от них побыстрее. И не забудь принять душ после этого.");
//         TranslationHelper.ModifyIL(il, "It's fine to relax, but you can't forget our end goal, now.", "Отдых - это, конечно, замечательно, но не забывай нашу конечную цель.");
//         TranslationHelper.ModifyIL(il, "Rest is important.. Take as much time as you need.", "Отдых важен... Отдыхай столько, сколько потребуется.");
//         TranslationHelper.ModifyIL(il, "Honestly, I prefer the flashy weapons. A little 'extra' never hurt anyone.", "Я, если честно, предпочитаю очень 'яркие' оружия. Лёгкая 'перчинка' никому не повредит.");
//         TranslationHelper.ModifyIL(il, "Unless you were on the receiving end. ", "Ну, только если это не ты тот, кого бьют.");
//         TranslationHelper.ModifyIL(il, "Weapon looks? They matter, but utility far outweighs cosmetic value.", "Внешний вид оружия? Он важен, но польза превосходит косметическую ценность.");
//         TranslationHelper.ModifyIL(il, "Sometimes, though... The choice is difficult. You get what I mean, right?", "Хотя иногда... Выбрать довольно трудно. Ты понимаешь о чём я, да?");
//         TranslationHelper.ModifyIL(il, "What is a 'Starfarer' you ask? Hmm, there's a lot to go over.", "Спрашиваешь, что такое 'Астры'? Хм, это достаточно обширное понятие.");
//         TranslationHelper.ModifyIL(il, "In short, we're the manifestation of the universe's will to vanquish threats...?", "Если кратко, то мы - проявления воли вселенной к уничтожению угроз?..");
//         TranslationHelper.ModifyIL(il, "Sorry. I think my memory's a little foggy. Just know I'm on your side, whatever may come.", "Извини. Воспоминания словно в тумане. Просто знай, я на твоей стороне.");
//         TranslationHelper.ModifyIL(il, "What is a 'Starfarer'? Let me see...", "Что значит 'Астра'? Дай подумать...");
//         TranslationHelper.ModifyIL(il, "Using your terms, we would be referred to as a sort of demigod. The universe calls us into action when needed.", "Выражаясь терминами вашего мира, мы некто вроде полубогов. Вселенная призывает нас в час нужды.");
//         TranslationHelper.ModifyIL(il, "That wasn't very helpful? Sorry. I feel like my memories are foggy. Don't fret, though- I'm with you all the way.", "Не очень понятно? Извиняюсь. Воспоминания словно затуманены. Но не беспокойся, я всегда с тобой.");
//         TranslationHelper.ModifyIL(il, "Don't forget about the Stellar Array!", "Не забывай о Созвездиях!");
//         TranslationHelper.ModifyIL(il, "Don't forget about the Stellar Array!", "Не забывай о Созвездиях!", 2);
//         TranslationHelper.ModifyIL(il, "It would be a shame if you did. I made it for you, after all.", "В конце концов, это я над ними старалась. Забудь ты про них, было бы обидно.");
//         TranslationHelper.ModifyIL(il, "It would be a shame if you did. I made it for you, after all.", "В конце концов, это я над ними старалась. Забудь ты про них, было бы обидно.", 2);
//         TranslationHelper.ModifyIL(il, "Have you been utilizing the Stellar Array? It'll help. Wait, forget I said that. Of course you know it'll help...", "Пользуешься Созвездиями? Они полезны. Стой, забудь сказанное. Конечно ты и без меня знаешь о их пользе...");
//         TranslationHelper.ModifyIL(il, "Hmm...", "Хм...");
//         TranslationHelper.ModifyIL(il, "Ah, it's nothing. Keep up the good work.", "А, нет, пустяки. Продолжай в том же духе.");
//         TranslationHelper.ModifyIL(il, "...Hm.", "...хм.");
//         TranslationHelper.ModifyIL(il, "Ah.. it's nothing.", "Эм... нет, ничего.");
//         TranslationHelper.ModifyIL(il, "! I have this idea about a weapon..   ", "! У меня тут появилась идея насчёт оружия...");
//         TranslationHelper.ModifyIL(il, "Wait.   ", "Постой.");
//         TranslationHelper.ModifyIL(il, "Uh.. Never mind. Forget I said anything.  ", "Эм... Не бери в голову. Я ничего не говорила.");
//         TranslationHelper.ModifyIL(il, "It would be far too large, to boot. And then there's the whole heating problem... ", "Вышло бы слишком громоздко. Ещё бы появились все эти проблемы с системой охлаждения...");
//         TranslationHelper.ModifyIL(il, "So, there's this weapon idea I was thinking of, "Итак, вот тебе идея с оружием, над которой я думала, ");
//         TranslationHelper.ModifyIL(il, "Wait.. Actually.. Forget it. Never mind.", "Подожди... А хотя... Забудь. Неважно.");
//         TranslationHelper.ModifyIL(il, "Even if we got past the energy cost, we'd have to deal with the weight...", "Даже если мы уложимся в стоимость\nэнергии, то остаётся проблема веса...");
//         TranslationHelper.ModifyIL(il, "Aren't some of these townspeople kind of awful?", "А эти городские жители не слишком оборзели?");
//         TranslationHelper.ModifyIL(il, "Everything costs so much! And they all have a monopoly!!", "Да ты посмотри на цены!\nИ на всю их монополию!");
//         TranslationHelper.ModifyIL(il, "These merchants are definitely upselling their wares for far too much!", "Эти торговцы определённо слишком завышают цены на свои товары!");
//         TranslationHelper.ModifyIL(il, "Do you think they'd notice if we shortchanged them, just a little? We shouldn't do that? I know... ...I know.", "Как думаешь, они заметят небольшую недоплату? Крохотную. Мы не должны этого делать? Знаю... знаю.");
//         TranslationHelper.ModifyIL(il, "Have you been utilizing the Stellar Array?", "Используешь Созвездия?");
//         TranslationHelper.ModifyIL(il, "So, what's next on the agenda? Let's see..", "Итак, что там у нас дальше по списку? Посмотрим...");
//         TranslationHelper.ModifyIL(il, "Have you been working on your town? Up for some mining? Ready for the next boss?", "Уже занимался своим городом? Или добычей руды? Готов к следующему боссу?");
...
//         TranslationHelper.ModifyIL(il, "We meet again, ", "Мы вновь встретились, ");
//         TranslationHelper.ModifyIL(il, "We meet again, ", "Мы вновь встретились, ", 2);
//         TranslationHelper.ModifyIL(il, "We meet again, ", "Мы вновь встретились, ", 3);
//         TranslationHelper.ModifyIL(il, ". I need your help.  ". Мне нужна твоя помощь. ");
...
//         TranslationHelper.ModifyIL(il, ". Again, I need your assistance.  ". И вновь мне нужна твоя помощь. ");
