...
namespace CalamityRuTranslate.Common
{
    internal class ArmorSetBonusLoader : ILoadable
    {
        ...
        private static void CalamityArmorSetInfo()
        {
            ...
            CalamityArmorSets.Add(new ArmorSetInfo(ModsCall.Calamity.ItemType("ReaverHeadgear"), ModsCall.Calamity.ItemType("ReaverScaleMail"), ModsCall.Calamity.ItemType("ReaverCuisses"), "ReaverExplorer"));
            CalamityArmorSets.Add(new ArmorSetInfo(ModsCall.Calamity.ItemType("ReaverHelm"), ModsCall.Calamity.ItemType("ReaverScaleMail"), ModsCall.Calamity.ItemType("ReaverCuisses"), "ReaverDefenser"));
            CalamityArmorSets.Add(new ArmorSetInfo(ModsCall.Calamity.ItemType("ReaverVisage"), ModsCall.Calamity.ItemType("ReaverScaleMail"), ModsCall.Calamity.ItemType("ReaverCuisses"), "ReaverSpeeder"));
