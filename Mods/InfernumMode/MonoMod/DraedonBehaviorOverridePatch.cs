...
public class DraedonBehaviorOverrideHandleDefeatStuff : ILPatcher
{
    ...
    public override ILContext.Manipulator PatchMethod { get; } = il =>
    {
        ...
        TranslationHelper.ModifyIL(il, "But now, I must return to my machinery. You may use the Codebreaker if you wish to face my creations once again.", "А теперь предпочту вернуться к своим механизмам. Можешь вновь использовать Дешифратор, если хочешь сразиться с моими творениями ещё раз.");
